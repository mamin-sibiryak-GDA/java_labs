...
import com.chess.engine.player.ai.pgn.FenUtilities;
import com.chess.engine.player.ai.pgn.MySqlGamePersistence;
...
import static com.chess.engine.player.ai.pgn.PGNUtilities.persistPGNFile;
import static com.chess.engine.player.ai.pgn.PGNUtilities.writeGameToPGNFile;
...
public final class Table extends Observable
{
    ...
    private Table()
    {
        ...
        this.useBook = false;
        this.pieceIconPath = "src/main/resources/simple/";
    ...
    private JMenu createPreferencesMenu()
    {
        ...
        {
            pieceIconPath = "src/main/resources/holywarriors/";
            Table.get().getBoardPanel().drawBoard(chessBoard);
        });
        ...
        {
            pieceIconPath = "src/main/resources/simple/";
            Table.get().getBoardPanel().drawBoard(chessBoard);
        });

        fancyMenMenuItem2.addActionListener(e ->
        {
            pieceIconPath = "src/main/resources/fancy2/";
            Table.get().getBoardPanel().drawBoard(chessBoard);
        });

        fancyMenMenuItem.addActionListener(e ->
        {
            pieceIconPath = "src/main/resources/fancy/";
            Table.get().getBoardPanel().drawBoard(chessBoard);
        });
